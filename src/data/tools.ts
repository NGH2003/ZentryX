...
export const tools = [
  ...
  },
  {
    ...
    description: "Generate random user data including names, emails, and addresses for testing",
    icon: "👤",
    category: "Generators",
    rating: 0,
    ratingCount: 0,
    uses: 0,
    tags: ["fake", "data", "generator", "mock"],
    featured: true
  },
  {
    id: 54,
    ...
    ratingCount: 0,
    uses: 0,
    tags: ["handwriting", "text", "generator", "image"],
    featured: false
  },
  {
    id: 55,
    ...
    ratingCount: 0,
    uses: 0,
    tags: ["wheel", "spinner", "random", "picker"],
    featured: true
  },
  {
    id: 56,
    ...
    ratingCount: 0,
    uses: 0,
    tags: ["minify", "code", "html", "css", "js"],
    featured: false
  },
  {
    id: 57,
    name: "Image Filters",
    description: "Apply professional filters and adjustments to your photos",
    icon: "🎨",
    category: "Design",
    rating: 0,
    ratingCount: 0,
    uses: 0,
    tags: ["image", "filter", "photo", "editor"],
    featured: true
  },
  {
    id: 58,
    name: "Image to Sketch",
    description: "Convert photos into pencil sketches instantly",
    icon: "✏️",
    category: "Design",
    rating: 0,
    ratingCount: 0,
    uses: 0,
    tags: ["sketch", "image", "converter", "art"],
    featured: false
  },
  {
    id: 59,
    ...
    ratingCount: 0,
    uses: 0,
    tags: ["watermark", "image", "copyright", "protect"],
    featured: false
  },
  {
    id: 60,
    name: "Rounded Corners",
    description: "Add rounded corners to images and download as PNG",
    icon: "🔲",
    category: "Design",
    rating: 0,
    ratingCount: 0,
    uses: 0,
    tags: ["rounded", "corners", "image", "border"],
    featured: false
  },
  {
    id: 61,
    name: "Image Crop & Resize",
    description: "Crop and resize images with an easy-to-use interface",
    icon: "✂️",
    category: "Design",
    rating: 0,
    ratingCount: 0,
    uses: 0,
    tags: ["crop", "resize", "image", "editor"],
    featured: true
  },
  {
    id: 62,
    name: "Password Strength Tester",
    description: "Analyze the strength and security of your passwords",
    icon: "💪",
    category: "Security",
    rating: 0,
    ratingCount: 0,
  ...
  },
  {
    ...
    ratingCount: 0,
    uses: 0,
    tags: ["regex", "tester", "developer", "code"],
    featured: false
  },
  {
    id: 64,
  ...
  },
  {
    ...
    description: "Generate tints and shades for any base color",
    icon: "🎭",
    category: "Design",
    rating: 0,
    ratingCount: 0,
  ...
  },
  {
    id: 66,
    name: "CSV Viewer",
    description: "View, search, and analyze CSV files in the browser",
    icon: "📊",
    category: "Utilities",
    rating: 0,
    ratingCount: 0,
    uses: 0,
    tags: ["csv", "viewer", "data", "table"],
    featured: false
  },
  {
    id: 67,
    name: "Text Column Splitter",
    description: "Split structured text into separate columns",
    icon: "↔️",
    category: "Text Tools",
    rating: 0,
    ratingCount: 0,
    uses: 0,
    tags: ["text", "split", "columns", "csv"],
    featured: false
  },
  {
    id: 68,
    name: "Notes App",
    description: "Simple offline notes with auto-save functionality",
    icon: "📝",
    category: "Utilities",
    rating: 0,
    ratingCount: 0,
    uses: 0,
    tags: ["notes", "app", "offline", "text"],
    featured: true
  },
  {
    id: 69,
    name: "To-Do App",
    description: "Manage your tasks with a simple offline to-do list",
    icon: "✅",
    category: "Utilities",
    rating: 0,
    ratingCount: 0,
    uses: 0,
    tags: ["todo", "task", "list", "app"],
    featured: true
  }
];
